...
set background=dark
let g:colors_name = 'solarize-light'
...
" Base colors.
let s:colors.base0 = { 'gui': '#14171d', 'cterm': 0 }
let s:colors.base1 = { 'gui': '#373b41', 'cterm': 8 }
let s:colors.base2 = { 'gui': '#c2ca6f', 'cterm': 10 }
let s:colors.base3 = { 'gui': '#becbd5', 'cterm': 12 }
let s:colors.base4 = { 'gui': '#f0d195', 'cterm': 11 }
let s:colors.base5 = { 'gui': '#85e7da', 'cterm': 14 }
let s:colors.base6 = { 'gui': '#a6a6a6', 'cterm': 7 }
let s:colors.base7 = { 'gui': '#c5c8c6', 'cterm': 15 }

" Other colors.
let s:colors.red     = { 'gui': '#b12929', 'cterm': 1  }
let s:colors.orange  = { 'gui': '#8a1414', 'cterm': 9  }
let s:colors.yellow  = { 'gui': '#de7932', 'cterm': 3  }
let s:colors.magenta = { 'gui': '#b294bb', 'cterm': 13 }
let s:colors.violet  = { 'gui': '#7c428f', 'cterm': 5  }
let s:colors.blue    = { 'gui': '#22679f', 'cterm': 4  }
let s:colors.cyan    = { 'gui': '#1e6d63', 'cterm': 6  }
let s:colors.green   = { 'gui': '#919d23', 'cterm': 2  }
